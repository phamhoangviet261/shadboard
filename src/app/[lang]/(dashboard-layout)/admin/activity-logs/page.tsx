...
export default function ActivityLogPage() {
  ...
  const getActionBadge = (action: string) => {
    if (action.includes("created")) return <Badge variant="default" className="bg-emerald-500 hover:bg-emerald-600">Created</Badge>
    ...
    if (action.includes("duplicated")) return <Badge variant="outline" className="border-blue-400 text-blue-500">Duplicated</Badge>
    if (action.includes("stock")) return <Badge variant="outline" className="border-orange-400 text-orange-500">Inventory</Badge>
    if (action.includes("bulk")) return <Badge variant="outline" className="border-purple-400 text-purple-500">Bulk</Badge>
  ...
  const getEntityIcon = (type: string) => {
    switch (type) {
      ...
      case "collection": return <Layers className="h-4 w-4 text-blue-500" />
      case "bulk_action": return <History className="h-4 w-4 text-purple-500" />
